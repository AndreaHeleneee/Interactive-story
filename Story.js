export let newStory = [
    ...
    //4 Billetkøb
    {
      header: "Billetkøb",
      imgUrl: "døren.jpg",
      description: "Du køber en billet (med studierabat blev det kun 90 kr) og får adgang til slottet. Du går direkte mod skatkammeret da du ved at det er der de har Kronjuvelerne. Men da du når til døren til skatkammeret, er den låst! Du hiver i døren men den giver sig slet ikke! Hvad gør du nu? Du kunne sparke døren op?",
      choices: [
    ...
    //5 Snigeren
    {
      header: "Snigeren",
      imgUrl: "sneak.jpg",
      description: "Du prøver at snige dig forbi vagterne, men de ser dig og råber dig an 'Haloo du skal altså have billet for at komme derind!' Du må vist hellere bare købe en billet.",
      choices: [
        {text: "Køb billet", nextState: 4}]
    },
    //6 Forklaringen
    ...
    //8 Låsen
    {
      ...
      description: "Du har øvet dig meget og efter kun to forsøg går låsen op med et klik. For at tyvene ikke skal se sig skubber du langsomt døren op. De er travlt beskæftiget med at få fat i kronjuvelerne og ænser ikke du er kommet ind af døren. Hvad gør du?",
      choices: [
    ...
    //9 Assistance
    {
      ...
      description: "Du får hurtigt tilkaldt vagterne som har nøgler til døren. De låser den op og bag den står tyvene i uld gang med at fylde deres tasker med de uvurderlige kronjuveler! I får hurtigt lagt dem alle ned og arresteret dem. Megagodt arbejde i dag! De siger tak og at du endelig må komme igen:)",
      choices: [
    ...
    //13 Vi kan selv
    {
      header: "Vi kan selv!",
      imgUrl: "Anholdelsen.jpg",
      description: "'Stoopp!! - I er anholdt!' I får hurtigt indfanget tyveneog som I giver den sidste håndjern på kommer de andre vagter løbende på grund af larmen - wow! virkelig godt arbejde venner siger de og klapper jer på ryggen.:)",
      choices: [
        {text: "Yayy, jeg gjorde det!", nextState: 14}]
    },
    // 14 En gang til?
